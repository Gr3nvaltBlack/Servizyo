            ...
            <section id="domestic-workers">
                ...
                <div className="domestic-workers-information">
                    ...
                    <div className="domestic-workers-card">
                        <div className="domestic-workers-card-header">
                            <div className="domestic-workers-card-header-text">
                                <span>Niveau 1</span>
                                <h3>Domestique de base</h3>
                                <p>Ménage & entretien courant</p>
                            </div>
                            <div className="domestic-workers-card-header-text-second">
                                <span>
                                    <h3>24 000</h3>
                                    <p> gdes/mois</p>
                                </span>
                        ...
                        <div className="domestic-workers-card-body">
                            <ul>
            ...
            <section id="man-workers">
                ...
                <div className="man-workers-information">
                    ...
                    <div className="man-workers-card">
                        <div className="man-workers-card-header">
                            <div className="man-workers-card-header-text">
                                <span>Cour Niveau 1</span>
                                <h3>Homme de cour standard</h3>
                                <p>Entretien extérieur complet</p>
                            </div>
                            <div className="man-workers-card-header-text-second">
                                <span>
                                    <h3>24 000</h3>
                                    <p> gdes/mois</p>
                                </span>
                        ...
                        <div className="man-workers-card-body">
                            <ul>
